...
public class NoticeFileController {
	private static final String UPLOAD_PATH = "C:\\work\\code\\YuLin-Coder\\No52CommunityPropertyManagementSystem\\WebRoot\\upload\\";
	@Autowired
...
//						+ File.separator;
				String uploadName = new SimpleDateFormat("yyyyMMddHHmmss").format(new Date())
						+ fileName;
				File localFile = new File(UPLOAD_PATH + uploadName);
